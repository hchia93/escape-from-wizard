...
namespace Game.Source
{
    public class GameStates
    {
        ...
        public void BindItemPickupSoundCallbacks(Action callback)
        {
        ...
        public void BindLockDestroyedSoundCallback(Action callback)
        {
