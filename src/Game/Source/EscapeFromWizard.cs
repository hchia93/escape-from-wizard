using Game.Source.Audio;
using Game.Source.GameObject.Dynamic;
using Game.Source.Map;
using Game.Source.TileEngine;
using Game.Source.ViewModel;
...
namespace Game.Source
{
    ...
    public class EscapeFromWizard : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            // Sound
            m_SoundManager = new SoundManager(Content);
            ...
            m_GameInput.OnEscapePressed = () => Exit();
        ...
        protected override void LoadContent()
        {
            ...
            m_Texture1px.SetData(new Color[] { Color.White });
        ...
        {
            m_SpriteBatch.Begin();
            m_SpriteBatch.Draw(m_QuestIncompleteMessage, new Vector2(50, GameSettings.m_ViewportCenter.Y), Color.White);
            m_SpriteBatch.End();
        }
        ...
        {
            m_SpriteBatch.Begin();
            m_SpriteBatch.Draw(screenBackground, new Vector2(0, 0), Color.White);
            m_SpriteBatch.End();
        }
        ...
        private void DrawGameScore()
        {
            ...
            m_SpriteBatch.DrawString(m_FontArialBlack14, scoreInfo, new Vector2(GameSettings.m_ViewportCenter.X - m_FontArialBlack14.MeasureString(scoreInfo).Length() / 2, GameSettings.m_ViewportCenter.Y - 50), Color.Black);
            m_SpriteBatch.End();
        }
        ...
        private void DrawLevel()
        {
            ...
            for (int row = 0; row < m_Level.GetTotalTileHeight(); ++row)
            {
                for (int col = 0; col < m_Level.GetTotalTileWidth(); ++col)
                {
                    ...
                    m_SpriteBatch.Draw(m_TileSpriteSheet.m_Texture, tileRect, m_TileSpriteSheet.GetSourceRectangle(tileID), Color.White);
                }
            }
            m_SpriteBatch.End();
        }
        ...
        private void DrawBackground()
        {
            ...
            for (int row = 0; row < 3; ++row)
            {
                ...
                {
                    m_SpriteBatch.Draw(m_Background, new Vector2(x, y), Color.White);
        ...
        private void DrawPlayer()
        {
            ...
            m_SpriteBatch.Draw(m_ObjectSpriteSheet.m_Texture, playerRect, m_ObjectSpriteSheet.GetSourceRectangle(4), Color.White);
        ...
        private void DrawWizard()
        {
            ...
            m_SpriteBatch.Draw(m_ObjectSpriteSheet.m_Texture, wizardRect, m_ObjectSpriteSheet.GetSourceRectangle(14), Color.White);
            m_SpriteBatch.End();
        }
        ...
        private void DrawMinions()
        {
            for (int i = 0; i < m_Minions.Length; i++)
            {
                ...
                m_SpriteBatch.Draw(m_ObjectSpriteSheet.m_Texture, minionRect, m_ObjectSpriteSheet.GetSourceRectangle(19), Color.White);
                m_SpriteBatch.End();
            }
        }
        ...
        private void DrawSpellItem()
        {
            ...
            foreach (var spellItem in m_GameStates.GetSpellItems())
            {
                if (!spellItem.GetIsLooted())
                {
                    ...
                    m_SpriteBatch.Draw(m_ObjectSpriteSheet.m_Texture, spellItemRect, m_ObjectSpriteSheet.GetSourceRectangle(spellItem.GetItemTypeIndex()), Color.White);
                }
            }
        ...
        private void DrawKey()
        {
            ...
            foreach (var key in m_GameStates.GetKeys())
            {
                if (!key.IsLooted())
                {
                    ...
                    m_SpriteBatch.Draw(m_ObjectSpriteSheet.m_Texture, keyRect, m_ObjectSpriteSheet.GetSourceRectangle((int)key.GetColor()), Color.White);
                }
            }
            m_SpriteBatch.End();
        }
        ...
        private void DrawLock()
        {
            ...
            foreach (var doorlock in m_GameStates.GetLocks())
            {
                if (!doorlock.IsDestroyed())
                {
                    ...
                    m_SpriteBatch.Draw(m_ObjectSpriteSheet.m_Texture, lockRect, m_ObjectSpriteSheet.GetSourceRectangle((int)doorlock.GetColor() + 15), Color.White);
                }
            }
        ...
        private void DrawLevelGridInfo()
        {
            ...
            {
                Rectangle horizontal_thin_rec = new Rectangle(0 + column * GameSettings.m_TileWidthInPx, 0, 1, GameSettings.m_TileHeightInPx * m_Level.GetTotalTileWidth());
                m_SpriteBatch.Draw(m_Texture1px, horizontal_thin_rec, Color.DarkGray);
            }

            for (int row = 0; row < m_Level.GetTotalTileHeight(); row++)
            {
                Rectangle vertical_thin_rec = new Rectangle(0, 0 + row * GameSettings.m_TileHeightInPx, GameSettings.m_TileWidthInPx * m_Level.GetTotalTileHeight(), 1);
                m_SpriteBatch.Draw(m_Texture1px, vertical_thin_rec, Color.DarkGray);
            }
            m_SpriteBatch.End();
        }
        ...
        private void DrawTileIndex()
        {
            ...
            for (int i = 0; i < m_Level.GetTotalTileHeight(); i++)
            {
                for (int j = 0; j < m_Level.GetTotalTileWidth(); j++)
                {
                    ...
                    m_SpriteBatch.DrawString(m_FontArialBlack14, infoString, new Vector2(i * GameSettings.m_TileHeightInPx + 16, j * GameSettings.m_TileWidthInPx + 16), Color.Blue, 0, originPosition, 1.0f, SpriteEffects.None, 0.5f);
                }
            }
            m_SpriteBatch.End();
        }
