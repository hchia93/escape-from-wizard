        ...
        public void DrawWidget(SpriteBatch spriteBatch)
        {
            if (m_SourceSpriteSheet != null)
            {
                for (int i = 0; i < m_MaxQuestItems; i++)
                {
                    ...
                    {
                        spriteBatch.Draw(m_SpriteSheetTexture, questItemPosition, m_FilledQuestItemRectangle, Color.White);
                    }
                    else
                    {
                        spriteBatch.Draw(m_SpriteSheetTexture, questItemPosition, m_EmptyQuestItemRectangle, Color.White);
                    }
                }
            }
        }
